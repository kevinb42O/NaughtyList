        ...
        {cooldownActive ? (
          <div className="mt-3 rounded-[1rem] border border-white/10 bg-black/25 p-3">
            ...
            <div className="mt-2 h-2 overflow-hidden rounded-full border border-white/10 bg-black/35">
              <div
                className="h-full rounded-full bg-[linear-gradient(90deg,rgba(99, 102, 241,0.85),rgba(129, 140, 248,0.95),rgba(199, 210, 254,0.9))] transition-[width] duration-1000 ease-linear"
