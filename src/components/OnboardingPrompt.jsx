  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-white/8 px-4 py-2.5">
        <p className="text-[0.62rem] font-black uppercase tracking-[0.22em] text-red-200">
          Complete your setup
        </p>
        <button
          type="button"
          ...
          <div className="flex items-center gap-3 py-3">
            ...
            {!iosHint && (
              <button
                ...
                disabled={installing}
                className="ml-auto shrink-0 rounded-full border border-red-500/50 bg-red-500/12 px-3 py-1.5 text-[0.62rem] font-black uppercase tracking-[0.14em] text-red-100 transition hover:bg-red-500/20 disabled:opacity-50"
              >
                {installing ? '…' : 'Install'}
              </button>
            )}
