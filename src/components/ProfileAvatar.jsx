...
export const avatarIconOptions = [
  { key: 'skull', label: 'Skull', Icon: Skull, accent: 'text-gray-100', glow: 'from-white/5 to-zinc-950' },
  { key: 'shield', label: 'Shield', Icon: Shield, accent: 'text-cyan-100', glow: 'from-cyan-500/24 to-zinc-950' },
  { key: 'crosshair', label: 'Crosshair', Icon: Crosshair, accent: 'text-gray-100', glow: 'from-white/5 to-zinc-950' },
  ...
  { key: 'target', label: 'Target', Icon: Target, accent: 'text-gray-100', glow: 'from-white/5 to-zinc-950' },
  ...
  { key: 'siren', label: 'Alert', Icon: Siren, accent: 'text-gray-100', glow: 'from-white/5 to-zinc-950' },
  ...
  { key: 'badge-alert', label: 'Marked', Icon: BadgeAlert, accent: 'text-gray-100', glow: 'from-white/5 to-zinc-950' },
]
...
export const clanBadgeIconOptions = [
  ...
  { key: 'rat', label: 'Rat', Icon: Rat, accent: 'text-gray-100', glow: 'from-white/5 to-zinc-950' },
]
