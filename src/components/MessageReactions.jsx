    ...
    >
      {badgeOption ? (
        <button
          ...
          className="absolute -bottom-3 right-2 z-10 inline-flex h-7 min-w-7 items-center justify-center gap-0.5 rounded-full border border-white/15 bg-zinc-950 px-1.5 text-sm shadow-lg shadow-black/50 ring-1 ring-black/40 transition hover:border-indigo-400/40 hover:bg-zinc-900 disabled:opacity-60"
        >
      ...
      <button
        ...
        title="Add reaction"
        className="absolute -bottom-3 left-2 z-10 inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-white/10 bg-zinc-950 text-gray-400 shadow-lg shadow-black/40 transition hover:border-indigo-400/45 hover:bg-indigo-500/10 hover:text-gray-100 disabled:opacity-60"
      >
      ...
      {open ? (
        <div
          className={`absolute bottom-8 z-20 flex items-center gap-1 rounded-full border border-white/12 bg-zinc-950/95 p-1.5 shadow-2xl shadow-black/60 ring-1 ring-indigo-500/10 backdrop-blur ${
            ...
            return (
              <button
                ...
                className={`inline-flex h-10 min-w-10 items-center justify-center rounded-full border text-base font-black transition hover:-translate-y-0.5 disabled:opacity-60 ${
                  selected
                    ? 'border-indigo-400/60 bg-indigo-500/20 text-white shadow-[0_0_18px_rgba(99, 102, 241,0.24)]'
