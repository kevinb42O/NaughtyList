      ...
      <section className="watchlist-shell relative z-10 -mt-[clamp(3.5rem,17vw,12.25rem)] rounded-[1.8rem] p-4 sm:p-5">
        ...
        <div className="flex flex-col gap-4 border-b border-white/10 pb-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <h2 className="text-[1.95rem] font-black uppercase italic leading-none tracking-[0.18em] text-transparent bg-gradient-to-r from-white via-white/5 to-transparent bg-clip-text sm:text-[2.3rem]">
                MOST WANTED
              </h2>
            </div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                className="inline-flex min-h-10 items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 text-[0.68rem] font-black uppercase tracking-[0.18em] text-gray-100 transition hover:bg-white/5"
              >
          ...
          <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
            <div className="relative">
              <Search
                className="pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-gray-200"
                aria-hidden="true"
              />
              <input
                type="search"
