    ...
    <div className="flex flex-col gap-5">
        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(280px,0.45fr)]">
          <div>
            <div className="mb-5 flex flex-wrap items-center gap-3">
              <HeartHandshake className="h-6 w-6 text-gray-100" aria-hidden="true" />
              <div>
            ...
            <div className="mt-5 flex flex-wrap items-center gap-3">
              ...
              {!isAuthenticated ? (
                <Link
                  to="/auth"
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-5 text-sm font-black uppercase tracking-[0.18em] text-gray-300 hover:border-white/10 hover:text-gray-100"
                >
      ...
      <section className="panel rounded-[1.8rem] p-5 sm:p-6">
        <div className="mb-4 flex items-center gap-3">
          <Coffee className="h-5 w-5 text-gray-100" aria-hidden="true" />
          <div>
        ...
        <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex min-h-14 items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-6 text-sm font-black uppercase tracking-[0.18em] text-gray-100 transition hover:bg-white/5"
          >
            <Coffee className="h-4 w-4" aria-hidden="true" />
            Open Ko-fi
            <ExternalLink className="h-4 w-4" aria-hidden="true" />
