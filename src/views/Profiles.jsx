    ...
    <div>
      ...
      {isAuthenticated ? (
        <div className="mb-5 flex items-center justify-end">
          <Link
            to="/profile"
            className="inline-flex min-h-10 items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 text-xs font-black uppercase tracking-[0.16em] text-gray-300 hover:border-red-500/40 hover:text-red-100"
          >
        ...
        <div className="mb-5 flex items-center justify-end">
          <Link
            to="/auth"
            className="inline-flex min-h-10 items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 text-xs font-black uppercase tracking-[0.16em] text-gray-400 hover:border-red-500/40 hover:text-red-100"
          >
