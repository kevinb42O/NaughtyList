      ...
      <article className={`flex items-end gap-2 ${mine ? 'justify-end' : 'justify-start'}`}>
        ...
        <div className="max-w-[86%] sm:max-w-[72%]">
          ...
          >
            ...
            />
            {deletingMedia ? (
              <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-white/10 bg-black/25 px-3 py-1 text-[0.62rem] font-black uppercase tracking-[0.14em] text-gray-100">
                ...
                return (
                  <button
                    ...
                    className={`flex w-full items-center gap-3 rounded-2xl border p-3 text-left transition ${
                      active
                        ? 'border-white/10 bg-white/5 shadow-lg shadow-white/5'
              ...
              <div className="flex min-h-16 items-center justify-between gap-3 border-b border-white/10 bg-black/20 px-4 py-3 backdrop-blur">
                <div className="flex min-w-0 items-center gap-3">
                  <button
                    ...
                    className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04] text-gray-200 transition hover:border-white/10 hover:text-gray-100 lg:hidden"
